...
const Contact = () =>{
    ...
    const onSubmit = async (event) => {
      ...
      "e1c09f13-954c-4f11-9b9e-711caa4f7dba");
    ...
    return(
        <div className="contact">
            <div className="contact-col">
                ...
                <ul>
                    <li> <img src={mail_icon} alt="" />dhruvgola69@gmail.com</li>
                    <li> <img src={phone_icon} alt="" />+91 9878-676-767</li>
                    <li> <img src={location_icon} alt="" />77 Apt Badshahpur, Gurugram<br/> DL 110055, India</li>
                </ul>
            </div>
            <div className="contact-col">
